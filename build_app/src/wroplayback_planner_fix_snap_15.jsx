...
// WRO Mission Planner – Reproducción (v20 - Refactorizado)
// - Arquitectura modular con hooks especializados
// - useCanvasRenderer: renderizado del canvas
// - useCollisionDetector: detección de colisiones
// - usePlaybackEngine: motor de reproducción/animación
...
export default function WROPlaybackPlanner() {
    ...
    // ============================================
    // HOOKS MODULARES - Colisiones y Renderizado
    // ============================================
    ...
    // Extraer funciones del hook de colisiones para uso local
    const {
        evaluateSegmentCollision: evaluateSegmentCollisionHook,
        formatObstacleNames,
        activeObstacles,
        halfRobotLengthPx
    } = collision;
    ...
    // Wrapper para evaluateSegmentCollision con la firma esperada
    const evaluateSegmentCollision = useCallback((startPose, endPose, reference) => {
        return evaluateSegmentCollisionHook(startPose, endPose, reference, getReferencePoint);
    }, [evaluateSegmentCollisionHook, getReferencePoint]);
    ...
    // ============================================
    // CANVAS RENDERER HOOK - Renderizado completo
    // ============================================
    const canvasRendererDeps = {
        canvasRef,
        bgImage,
        bgOpacity,
        grid,
    ...
    const { draw } = useCanvasRenderer(canvasRendererDeps);

    // ============================================
    // PLAYBACK ENGINE HOOK - Motor de reproducción
    // ============================================
    const playbackEngineDeps = {
        sections,
        initialPose,
        unitToPx,
        computePoseUpToSection,
    ...
    const {
        ...
        playPose,
        actionCursorRef
    } = usePlaybackEngine(playbackEngineDeps);
